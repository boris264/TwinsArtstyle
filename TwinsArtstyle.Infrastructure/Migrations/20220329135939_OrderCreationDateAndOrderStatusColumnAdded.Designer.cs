...
namespace TwinsArtstyle.Infrastructure.Migrations
{
    ...
    [Migration("20220329135939_OrderCreationDateAndOrderStatusColumnAdded")]
    partial class OrderCreationDateAndOrderStatusColumnAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TwinsArtstyle.Infrastructure.Models.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TwinsArtstyle.Infrastructure.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TwinsArtstyle.Infrastructure.Models.Address", b =>
                {
                    b.HasOne("TwinsArtstyle.Infrastructure.Models.User", "User")
                        .WithMany("Addresses")
                        .HasForeignKey("UserId")
            ...
            modelBuilder.Entity("TwinsArtstyle.Infrastructure.Models.CartProductCount", b =>
                {
                    b.HasOne("TwinsArtstyle.Infrastructure.Models.Cart", "Cart")
                        .WithMany("CartProductsCount")
                        .HasForeignKey("CartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TwinsArtstyle.Infrastructure.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("TwinsArtstyle.Infrastructure.Models.Order", b =>
                {
                    b.HasOne("TwinsArtstyle.Infrastructure.Models.Address", "Address")
                        .WithMany()
            ...
            modelBuilder.Entity("TwinsArtstyle.Infrastructure.Models.OrderProductCount", b =>
                {
                    b.HasOne("TwinsArtstyle.Infrastructure.Models.Order", "Order")
            ...
            modelBuilder.Entity("TwinsArtstyle.Infrastructure.Models.Product", b =>
                {
                    b.HasOne("TwinsArtstyle.Infrastructure.Models.Category", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("TwinsArtstyle.Infrastructure.Models.Cart", b =>
                {
                    b.Navigation("CartProductsCount");
                });
